...
*ACP-shaped checkout + AP2-shaped mandates, running on Razorpay test-mode rails, with a UAP-style guardrail and audit layer, driven end-to-end by an LLM buyer agent.*
